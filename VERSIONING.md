...
- **Packaged application release** (for example `0.9.5.86`). The single
...
`0.9.5.5` and onward through `0.9.5.86`) to express pre-1.0 packaged releases
...
| --- | --- |
| Runtime, API, browser shell, Admin | Packaged application release (`0.9.5.86`) |

...
Moved verbatim from the `README.md` section "Current repository status" on 2026-07-31 (packaged release v0.9.5.47). The README now fronts durable design decisions; per-release status prose belongs to this file's release sections.

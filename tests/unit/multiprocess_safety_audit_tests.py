...
class MultiprocessSafetyInventoryTests(unittest.TestCase):
    ...
    def test_all_registered_games_are_reachably_classified_and_blocked(self) -> None:
        ...
        # Pin the exact current family cardinalities after Plinko retires direct publication.
        self.assertEqual(
            {
            ...
            {"player_document_load_save": 5, "shared_simple_game_load_save": 11, "provider_atomic_player_document": 30},  # Pin current counts.
        )

...
class RequestLatencyBenchmarkTests(unittest.TestCase):
    ...
    def test_governance_allocation_is_unique_and_narrow(self) -> None:
        ...
        aggregate_allocations = {
            ...
            "CHUCK-007": "Chuck-a-Luck",  # Bind prepared settlement orchestration to the shared helper.
            ...
            "SLOT-038": "Slots",  # Bind bonus, progressive, optional migration, and recent-spin state to provider-current callbacks.
            "TEST-231": "Tests",  # Bind real Slots publication ordering, sibling, optional-field, and cleanup evidence.
            "TEENP-003": "Teen Patti",  # Bind rounds, receipts, recovery, settlement, history, and cleanup to provider-current callbacks.
            ...
            "FAN-TAN-007": "Fan-Tan",  # Bind Fan-Tan orchestration to one SimpleWagerGame coordinator.
            ...
            "STORAGE-018": "Storage",  # Bind one unconditional provider-owned state-document boundary.
            "TEST-247": "Tests",  # Bind facade parity, containment, rollback, and selector-removal evidence.
            ...
            "STORAGE-025": "Storage",  # Bind the unchanged provider-neutral storage acceptance contract.
            "TEST-257": "Tests",  # Bind JSON, MySQL, and PostgreSQL A-J conformance evidence.

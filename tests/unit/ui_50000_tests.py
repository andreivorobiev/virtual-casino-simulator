"""Focused TEST-072 proofs for the exact-source 50,000-cycle UI harness."""
...
# Prove TEST-072 allocation, control classification, and exact-source resume invariants.

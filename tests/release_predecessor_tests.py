...
class ReleasePredecessorTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.write_json(
            "contracts/compatibility/app-0.9.5.19.json",
            {
                "app_version": "0.9.5.19",
                "predecessor": {
                    "app_version": "0.9.5.18",
                    "compatibility_record": "contracts/compatibility/app-0.9.5.18.json",
        ...
        self.write_json("contracts/compatibility/app-0.9.5.18.json", {"app_version": "0.9.5.18"})
    ...
    def test_resolves_declared_predecessor_tag(self):
        ...
        tag = resolve_release_predecessor.predecessor_tag("0.9.5.19", self.root)
        # Require the retained v0.9.5.18 tag rather than release-list ordering.
        self.assertEqual(tag, "v0.9.5.18")
    ...
    def test_rejects_redirected_predecessor_record(self):
        ...
        with self.assertRaises(ValueError):
            ...
            resolve_release_predecessor.predecessor_tag("0.9.5.19", self.root)
    ...
    def test_verifies_exact_downloaded_manifest(self):
        ...
        tag = resolve_release_predecessor.verify_manifest("0.9.5.19", manifest, self.root)
    ...
    def test_rejects_cross_tag_manifest(self):
        ...
        with self.assertRaises(ValueError):
            ...
            resolve_release_predecessor.verify_manifest("0.9.5.19", manifest, self.root)
    ...
    def pin_manifest_digest(self, digest: str) -> None:
        ...
        path = self.root / "contracts" / "compatibility" / "app-0.9.5.19.json"

...
class ReleasePredecessorTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.write_json(
            "contracts/compatibility/app-0.9.5.9.json",
            {
                "app_version": "0.9.5.9",
                "predecessor": {
                    "app_version": "0.9.5.8",
        ...
        self.write_json("contracts/compatibility/app-0.9.5.8.json", {"app_version": "0.9.5.8"})
    ...
    def test_resolves_declared_predecessor_tag(self):
        ...
        tag = resolve_release_predecessor.predecessor_tag("0.9.5.9", self.root)
        # Require the retained v0.9.5.8 tag rather than release-list ordering.
        self.assertEqual(tag, "v0.9.5.8")
    ...
    def test_rejects_redirected_predecessor_record(self):
        ...
        self.write_json(
            "contracts/compatibility/app-0.9.5.9.json",
            {
                ...
                "predecessor": {
                    "app_version": "0.9.5.8",
                    "compatibility_record": "contracts/compatibility/app-0.9.5.7.json",
                    "required_artifact": "release-manifest.json",
                    "source_commit_sha": "9" * 40,
                    "artifact_sha256": "8" * 64,
        ...
        with self.assertRaises(ValueError):
            ...
            resolve_release_predecessor.predecessor_tag("0.9.5.9", self.root)
    ...
    def test_verifies_exact_downloaded_manifest(self):
        ...
        tag = resolve_release_predecessor.verify_manifest("0.9.5.9", manifest, self.root)
    ...
    def test_rejects_cross_tag_manifest(self):
        ...
        with self.assertRaises(ValueError):
            ...
            resolve_release_predecessor.verify_manifest("0.9.5.9", manifest, self.root)
    ...
    def pin_manifest_digest(self, digest: str) -> None:
        ...
        path = self.root / "contracts" / "compatibility" / "app-0.9.5.9.json"

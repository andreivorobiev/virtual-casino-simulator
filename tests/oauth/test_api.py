...
class OAuthApiTests(unittest.TestCase):
    ...
    def test_diagnostic_projection_has_exact_allowlisted_keys(self):
        ...
        expected_keys = {"provider", "flow", "status", "configuration_ready", "runtime_available", "enabled_requested", "client_id_configured", "client_secret_configured", "callback_url", "missing_variables", "problems"}

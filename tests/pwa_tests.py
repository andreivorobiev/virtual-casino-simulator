...
EXPECTED_SHELL_ASSETS = {
    ...
    "/core/api.js", "/core/brand.js", "/core/feedback.js", "/core/i18n.js", "/core/pwa.js", "/core/ui.js", "/core/voice.js",
...
class PwaFoundationTests(unittest.TestCase):
    ...
    def test_browser_acceptance_serializes_worker_readiness(self):
        ...
        controller_index = pwa_case.index("Boolean(navigator.serviceWorker.controller) && window.CasinoPwa?.version==='0.9.5.17'")

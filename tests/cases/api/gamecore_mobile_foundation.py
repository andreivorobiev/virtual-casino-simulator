...
def run_cases(run_case):
    ...
    run_case("API-GAMECORE-005", ["GAMECORE-005", "GAMECORE-006", "GAMECORE-007", "TEST-233", "TEST-234", "TEST-235", "TEST-236", "TEST-237", "TEST-238", "TEST-239", "TEST-240"], _run_simple_game_atomic_tests)

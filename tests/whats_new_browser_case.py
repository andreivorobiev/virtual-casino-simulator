...
def run_whats_new_browser_case(page, base, root, visual_matrix, game_evidence):
    ...
    with tempfile.TemporaryDirectory(prefix="casino-tour-browser-") as temporary:
        ...
        try:
            ...
            # Retain the persisted post-refresh absence under the still-active governed Russian mobile context.
            game_evidence("after-pass-whats-new-dismissed-refresh-ru-RU-mobile.png", "whats_new", ["dismissed_refresh"], "ru-RU", "mobile")

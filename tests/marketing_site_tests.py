...
class MarketingSiteTests(unittest.TestCase):
    ...
    def test_module_and_visual_ownership_are_complete(self) -> None:
        ...
        self.assertEqual((manifest["modules"]["marketing_site"], module["module"], module["version"], module["paths"], module["requirements_prefixes"]), ("1.0.0", "marketing_site", "1.0.0", ["site/tiltseven/"], ["MARKETING"]))

...
ESSENTIAL_STAGE_CONTRACTS = {
    "big_six_wheel": {"stage": ".big-six-wheel__stage", "contained_items": (".big-six-wheel__wheel-shell", ".big-six-wheel__pointer", ".big-six-wheel__hub"), "paint_items": {".big-six-wheel__wheel": ".big-six-wheel__wheel-shell"}},  # Contain stable theater geometry while requiring the rotating square wheel to paint across its circular clipping owner.
}

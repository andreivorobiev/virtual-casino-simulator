...
class CiQualificationWorkflowTests(unittest.TestCase):
    ...
    def test_browser_shard_affinity_groups_are_contiguous_and_guarded(self):
        ...
        case_ids = browser_runner_module.browser_case_ids()
        # Bind the complete inventory after adding dedicated Marble Race lifecycle acceptance. (TEST-248)
        self.assertEqual(len(case_ids), 127)
        ...
        # Bind deterministic load totals after packing the new dedicated Marble Race case. (TEST-242, TEST-248)
        self.assertEqual(shard_loads, (223, 221, 222, 221, 221, 222))

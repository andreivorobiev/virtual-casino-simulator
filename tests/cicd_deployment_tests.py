...
class CiQualificationWorkflowTests(unittest.TestCase):
    ...
    def test_browser_shard_affinity_groups_are_contiguous_and_guarded(self):
        ...
        # Require the current exact suite inventory after adding provider-signup acceptance.
        self.assertEqual(len(case_ids), 114)
        ...
        self.assertEqual(shard_loads, (202, 203, 201, 202, 201, 202))

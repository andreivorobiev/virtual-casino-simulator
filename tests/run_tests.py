            ...
            try:
                ...
                def invitation_browser():
                    ...
                    for locale in ('en-US','ru-RU'):
                        ...
                        assert public_zoom_geometry['documentScrollWidth']<=public_zoom_geometry['viewport']+1 and public_zoom_geometry['panelScrollWidth']<=public_zoom_geometry['panelClientWidth']+1 and public_zoom_geometry['formScrollWidth']<=public_zoom_geometry['formClientWidth']+1 and public_zoom_geometry['panelBox']['left']>=-1 and public_zoom_geometry['panelBox']['right']<=public_zoom_geometry['viewport']+1 and all(control['box']['left']>=public_zoom_geometry['formBox']['left']-1 and control['box']['right']<=public_zoom_geometry['formBox']['right']+1 and (control['tag']=='select' or control['scrollWidth']<=control['clientWidth']+1) for control in public_zoom_geometry['controls']), {'locale':locale,'viewport':'mobile','zoom':200,'geometry':public_zoom_geometry}

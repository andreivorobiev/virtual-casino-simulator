...
"""
            ...
            for decision in ("ride", "pull"):
                ...
                process = subprocess.Popen([sys.executable, "-c", worker_source, decision, str(ready_path), str(go_path)], cwd=repository_root, env=environment, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)

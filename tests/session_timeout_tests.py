"""Focused tests for registered-account idle and absolute session-timeout enforcement. (SESSION-008)"""
...
# Prove registered accounts are signed out on idle and absolute limits while fresh sessions slide forward. (SESSION-008)

...
class ReleaseArtifactTests(unittest.TestCase):
    ...
    def test_current_release_compatibility_binds_private_invite_predecessor(self):
        ...
        compatibility = json.loads((package_app.ROOT / "contracts" / "compatibility" / "app-0.9.5.5.json").read_text(encoding="utf-8"))
        # Require the canonical release and restricted-preview channel identities.
        self.assertEqual((compatibility["app_version"], compatibility["release_channel"]), ("0.9.5.5", "restricted-preview-private-invite"))
        # Require the exact prior packaged release and retained manifest filename.
        self.assertEqual(compatibility["predecessor"], {"app_version": "9.5.6", "compatibility_record": "contracts/compatibility/app-9.5.6.json", "required_artifact": "release-manifest.json"})

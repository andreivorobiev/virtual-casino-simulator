...
class ReleaseArtifactTests(unittest.TestCase):
    ...
    def test_current_release_compatibility_binds_private_invite_predecessor(self):
        ...
        compatibility = json.loads((package_app.ROOT / "contracts" / "compatibility" / "app-0.9.5.63.json").read_text(encoding="utf-8"))
        # Require the canonical release and restricted-preview channel identities.
        self.assertEqual((compatibility["app_version"], compatibility["release_channel"]), ("0.9.5.63", "restricted-preview-private-invite"))
        ...
        self.assertEqual(
            compatibility["predecessor"],
            {
                ...
                "source_commit_sha": "3967dab1419bcc8ebfd7c8584a4bb9baa4665b34",
                "artifact_sha256": "0486a4da292c66615f4df37c6986c65bea36ccf75185c7de2223c0bb07ee2e98",
                "manifest_sha256": "47cfd70de9c25c8e0330971414c7559d64bb16d5e6998de8f8ecf209c4136f48",
            },
        )
        ...
        self.assertEqual(resolve_release_predecessor.predecessor_tag("0.9.5.63"), "v0.9.5.62")

...
def check_required_token_mark():
    ...
    # Accept either an inline token-mark template or delegation to the i18n formatter,
    # whose own mark is checked below. (issue #555 repaired this for the delegation form.)

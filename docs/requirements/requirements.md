...
## Craps integration addendum

GitHub issue #77 integrates issue #90 after Chuck-a-Luck and supplies canonical registration, permanent requirements, test discovery, and EN/RU visual evidence.

| ID | Requirement | Status | API tests | Browser tests |
|---|---|---|---|---|
| CRAPS-001 | Pass Line and Don't Pass implement come-out, point, win, loss, and bar-12 refund rules with server-authoritative dice. | PASS | API-CRAPS-001 | BR-CRAPS-001 |
| CRAPS-002 | Session-bound rounds, roll actions, recovery state, history, and canonical routes remain private and reload-safe. | PASS | API-CRAPS-001, API-WALLET-RESTART-001 | BR-CRAPS-001 |
| CRAPS-003 | Wagers, payouts, and refunds use ledger-only durable retry-safe request identities. | PASS | API-CRAPS-001 |  |
| CRAPS-004 | English and Russian play remains responsive, accessible, reduced-motion safe, and timer-clean. | PASS |  | BR-CRAPS-001 |
| CRAPS-005 | Catalog, contract, browser, long-suite, requirement, module, version, and visual evidence are traceable. | PASS | API-CATALOG-001, LONG-SUITE-100 | BR-CATALOG-DISCOVERY-001, BR-CRAPS-001 |

## Crown and Anchor integration addendum

GitHub issue #77 integrates issue #133 after Craps and supplies canonical registration, permanent requirements, test discovery, and EN/RU visual evidence.

| ID | Requirement | Status | API tests | Browser tests |
|---|---|---|---|---|
| CAA-001 | Three symbol dice implement six coverage targets and transparent one-, two-, and three-hit net payouts. | PASS | API-CAA-001 | BR-CAA-001 |
| CAA-002 | Session-bound settled rounds, history, restart state, and canonical routes remain private and reload-safe. | PASS | API-CAA-001, API-WALLET-RESTART-001 | BR-CAA-001 |
| CAA-003 | Aggregate wagers and returned credits use ledger-only durable retry-safe request identities. | PASS | API-CAA-001 |  |
| CAA-004 | English and Russian play remains responsive, accessible, reduced-motion safe, and timer-clean. | PASS |  | BR-CAA-001 |
| CAA-005 | Catalog, contract, browser, long-suite, requirement, module, version, and visual evidence are traceable. | PASS | API-CATALOG-001, LONG-SUITE-100 | BR-CATALOG-DISCOVERY-001, BR-CAA-001 |

## Over/Under 7 integration addendum

GitHub issue #77 integrates issue #135 after Crown and Anchor and supplies canonical registration, permanent requirements, test discovery, and EN/RU visual evidence.

| ID | Requirement | Status | API tests | Browser tests |
|---|---|---|---|---|
| OU7-001 | Two server-authoritative dice implement under-seven, exactly-seven, and over-seven outcomes with transparent returns. | PASS | API-OU7-001 | BR-OU7-001 |
| OU7-002 | Session-bound settled plays, history, restart state, and canonical routes remain private and reload-safe. | PASS | API-OU7-001, API-WALLET-RESTART-001 | BR-OU7-001 |
| OU7-003 | Aggregate wagers and returned credits use ledger-only durable retry-safe action identities. | PASS | API-OU7-001 |  |
| OU7-004 | English and Russian play remains responsive, accessible, reduced-motion safe, and timer-clean. | PASS |  | BR-OU7-001 |
| OU7-005 | Catalog, contract, browser, long-suite, requirement, module, version, and visual evidence are traceable. | PASS | API-CATALOG-001, LONG-SUITE-100 | BR-CATALOG-DISCOVERY-001, BR-OU7-001 |

## Plinko integration addendum

GitHub issue #77 integrates issue #136 after Over/Under 7 and supplies canonical registration, permanent requirements, test discovery, and EN/RU visual evidence.
...
| PLINKO-005 | Catalog, contract, browser, long-suite, requirement, module, version, and visual evidence are traceable. | PASS | API-CATALOG-001, LONG-SUITE-100 | BR-CATALOG-DISCOVERY-001, BR-PLINKO-001 |

## Fan-Tan integration addendum

GitHub issue #77 integrates the isolated issue #137 game slice after Plinko. The game keeps its module-owned implementation while the shared lane supplies canonical version registration, catalog and contract traceability, requirements, test discovery, and EN/RU visual evidence.

| ID | Requirement | Status | API tests | Browser tests |
|---|---|---|---|---|
| FAN-TAN-001 | A covered pile is counted by fours and settles residue one through four with transparent three-to-one net rules. | PASS | API-FAN-TAN-001 | BR-FAN-TAN-001 |
| FAN-TAN-002 | Session-bound rounds, history, restart state, durable action receipts, and canonical routes remain private and reload-safe. | PASS | API-FAN-TAN-001, API-WALLET-RESTART-001 | BR-FAN-TAN-001 |
| FAN-TAN-003 | Aggregate residue wagers and returned-token credits use ledger-only durable retry-safe action identities. | PASS | API-FAN-TAN-001 |  |
| FAN-TAN-004 | English and Russian play remains responsive, accessible, reduced-motion safe, and timer-clean. | PASS |  | BR-FAN-TAN-001 |
| FAN-TAN-005 | Catalog, contract, browser, long-suite, requirement, module, version, and visual evidence are traceable. | PASS | API-CATALOG-001, LONG-SUITE-100 | BR-CATALOG-DISCOVERY-001, BR-FAN-TAN-001 |

## Andar Bahar integration addendum

Issue #140 is integrated through the catalog under shared integration issue #77.

| ID | Requirement | Status | API Tests | Browser Tests |
| --- | --- | --- | --- | --- |
| AB-001 | A joker or match card sets the rank and alternating Andar/Bahar deals stop at the first matching rank with even-money settlement. | PASS | API-AB-001 | BR-AB-001 |
| AB-002 | Session-bound rounds, history, restart state, durable action receipts, and canonical routes remain private and reload-safe. | PASS | API-AB-001, API-WALLET-RESTART-001 | BR-AB-001 |
...
## Caribbean Stud integration addendum

Issue #132 is integrated through the catalog under shared integration issue #77.

| ID | Requirement | Status | API Tests | Browser Tests |
| --- | --- | --- | --- | --- |
| CS-001 | An ante deals five player cards and one dealer upcard before a call of exactly twice the ante or fold decision, followed by ace-king dealer qualification and transparent poker settlement. | PASS | API-CS-001 | BR-CS-001 |
| CS-002 | Session-bound decision rounds, private dealer hole cards, history, restart state, durable action receipts, and canonical routes remain private and reload-safe. | PASS | API-CS-001, API-WALLET-RESTART-001 | BR-CS-001 |
| CS-003 | Ante and call debits plus returned-token settlement credits use ledger-only durable retry-safe action identities, while folds add no token movement. | PASS | API-CS-001 |  |
| CS-004 | English and Russian play remains responsive, accessible, reduced-motion safe, and timer-clean. | PASS |  | BR-CS-001 |
| CS-005 | Catalog, contract, browser, long-suite, requirement, module, version, and visual evidence are traceable. | PASS | API-CATALOG-001, LONG-SUITE-100 | BR-CATALOG-DISCOVERY-001, BR-CS-001 |

## Let It Ride integration addendum

Issue #134 is integrated through the catalog under shared integration issue #77.

| ID | Requirement | Status | API Tests | Browser Tests |
| --- | --- | --- | --- | --- |
| LIR-001 | Three equal base-wager units fund a five-card poker round with three player cards and two staged ride-or-pull decisions before community-card settlement beginning at a pair of tens. | PASS | API-LIR-001 | BR-LIR-001 |
| LIR-002 | Session-bound rounds, hidden community cards, history, restart state, durable action receipts, and canonical routes remain private and reload-safe. | PASS | API-LIR-001, API-WALLET-RESTART-001 | BR-LIR-001 |
...
## Joker Poker integration addendum

Issue #130 is integrated through the catalog under shared integration issue #77.

| ID | Requirement | Status | API Tests | Browser Tests |
| --- | --- | --- | --- | --- |
| JP-001 | A 53-card single-hand draw profile contains exactly one wild joker, reload-safe holds, Kings-or-Better qualification, and distinct natural royal, five-of-a-kind, and wild royal paytable rows. | PASS | API-JP-001 | BR-JP-001 |
| JP-002 | Session-bound source hands, hold selections, history, restart state, durable action receipts, and canonical routes remain private and reload-safe. | PASS | API-JP-001, API-WALLET-RESTART-001 | BR-JP-001 |

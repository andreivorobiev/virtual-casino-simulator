...
Packaged release numbers use the four-part scheme documented in [the release versioning policy](release_versioning.md). The current line is `0.9.5.47`; `0.9.6.0` remains reserved until the frozen open-PR cohort is fully resolved.

# AGENTS.md - bots module

Scope this Codex conversation to the `bots` module unless the task explicitly lists impacted components.
...
- Read `modules/bots.json` before editing.

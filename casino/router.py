...
class Router:
    ...
    def dispatch(self, method: str, raw_path: str, body: dict | None = None, context: dict | None = None):
        ...
        path = parsed.path
        # Parse blank values and retain repeated parameters so security-sensitive routes can reject ambiguity.
        parsed_query = parse_qs(parsed.query, keep_blank_values=True)
        # Preserve a scalar for ordinary singleton queries and the complete list for duplicates.

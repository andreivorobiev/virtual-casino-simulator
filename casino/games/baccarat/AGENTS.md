# AGENTS.md - baccarat module

Scope this Codex conversation to the `baccarat` module unless the task explicitly lists impacted components.
...
- Read `modules/baccarat.json` before editing.

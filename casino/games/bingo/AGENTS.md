# AGENTS.md - bingo module

Scope this Codex conversation to the `bingo` module unless the task explicitly lists impacted components.
...
- Read `modules/bingo.json` before editing.

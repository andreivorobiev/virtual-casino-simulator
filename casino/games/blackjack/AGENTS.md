# AGENTS.md - blackjack module

Scope this Codex conversation to the `blackjack` module unless the task explicitly lists impacted components.
...
- Read `modules/blackjack.json` before editing.

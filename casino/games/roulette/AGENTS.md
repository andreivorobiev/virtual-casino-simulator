# AGENTS.md - roulette module

Scope this Codex conversation to the `roulette` module unless the task explicitly lists impacted components.
...
- Read `modules/roulette.json` before editing.

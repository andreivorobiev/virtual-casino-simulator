# AGENTS.md - slots module

Scope this Codex conversation to the `slots` module unless the task explicitly lists impacted components.
...
- Read `modules/slots.json` before editing.

...
# Bound guest creations per trusted source address inside the rolling window so one source cannot burn the active-principal capacity. (issue #555)
GUEST_CREATES_PER_IP = int(os.environ.get("CASINO_GUEST_CREATES_PER_IP", "30"))
# Set the rolling per-source guest-creation window length in seconds. (issue #555)

# Codex task prompt: contracts

Read root `AGENTS.md`, then read `modules/contracts.json` and any nested `AGENTS.md` for this module.

## Scope

Work only on the `contracts` module unless the GitHub issue explicitly lists impacted modules.

# Codex task prompt: bots

Read root `AGENTS.md`, then read `modules/bots.json` and any nested `AGENTS.md` for this module.

## Scope

Work only on the `bots` module unless the GitHub issue explicitly lists impacted modules.

# Codex task prompt: admin

Read root `AGENTS.md`, then read `modules/admin.json` and any nested `AGENTS.md` for this module.

## Scope

Work only on the `admin` module unless the GitHub issue explicitly lists impacted modules.

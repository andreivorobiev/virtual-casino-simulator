# Codex task prompt: docs

Read root `AGENTS.md`, then read `modules/docs.json` and any nested `AGENTS.md` for this module.

## Scope

Work only on the `docs` module unless the GitHub issue explicitly lists impacted modules.

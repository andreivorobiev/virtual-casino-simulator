# Codex task prompt: bingo

Read root `AGENTS.md`, then read `modules/bingo.json` and any nested `AGENTS.md` for this module.

## Scope

Work only on the `bingo` module unless the GitHub issue explicitly lists impacted modules.

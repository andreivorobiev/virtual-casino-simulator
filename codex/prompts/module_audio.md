# Codex task prompt: audio

Read root `AGENTS.md`, then read `modules/audio.json` and any nested `AGENTS.md` for this module.

## Scope

Work only on the `audio` module unless the GitHub issue explicitly lists impacted modules.

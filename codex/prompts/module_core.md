# Codex task prompt: core

Read root `AGENTS.md`, then read `modules/core.json` and any nested `AGENTS.md` for this module.

## Scope

Work only on the `core` module unless the GitHub issue explicitly lists impacted modules.

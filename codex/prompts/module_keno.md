# Codex task prompt: keno

Read root `AGENTS.md`, then read `modules/keno.json` and any nested `AGENTS.md` for this module.

## Scope

Work only on the `keno` module unless the GitHub issue explicitly lists impacted modules.

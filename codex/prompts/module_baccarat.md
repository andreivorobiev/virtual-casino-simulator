# Codex task prompt: baccarat

Read root `AGENTS.md`, then read `modules/baccarat.json` and any nested `AGENTS.md` for this module.

## Scope

Work only on the `baccarat` module unless the GitHub issue explicitly lists impacted modules.

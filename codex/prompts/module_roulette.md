# Codex task prompt: roulette

Read root `AGENTS.md`, then read `modules/roulette.json` and any nested `AGENTS.md` for this module.

## Scope

Work only on the `roulette` module unless the GitHub issue explicitly lists impacted modules.

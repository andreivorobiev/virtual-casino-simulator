# Codex task prompt: blackjack

Read root `AGENTS.md`, then read `modules/blackjack.json` and any nested `AGENTS.md` for this module.

## Scope

Work only on the `blackjack` module unless the GitHub issue explicitly lists impacted modules.

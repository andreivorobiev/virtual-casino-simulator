# Codex task prompt: autoplay

Read root `AGENTS.md`, then read `modules/autoplay.json` and any nested `AGENTS.md` for this module.

## Scope

Work only on the `autoplay` module unless the GitHub issue explicitly lists impacted modules.

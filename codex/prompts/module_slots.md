# Codex task prompt: slots

Read root `AGENTS.md`, then read `modules/slots.json` and any nested `AGENTS.md` for this module.

## Scope

Work only on the `slots` module unless the GitHub issue explicitly lists impacted modules.

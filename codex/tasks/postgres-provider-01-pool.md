...
- Branch: `codex/1056-postgres-pool`
- Base branch and commit: exact accepted protected-main descendant after #1055; record the protected merge SHA before mutation
...
- Required owner approval or external gate: resolved — mirror MySQL with default capacity 16 and accepted explicit range 1–64
...
- PR URL and state: one draft PR until exact checks and independent review are satisfied.
- Exact base and head SHA: mandatory.
- Checks and review state: mandatory.
- Open questions to report: none; capacity is fixed at default 16 with accepted range 1–64.
- Stop conditions: moved base; shared owner; provider-native leakage; connector/live target; scope expansion.
- Merge recommendation format: `Codex review and normal merge only after every exact-head gate and both independent reviews are green.`

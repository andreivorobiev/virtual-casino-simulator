...
Packaged application release: `0.9.5.11`
...
This repository has advanced beyond the original v9.1.1 bootstrap snapshot. Packaged release v0.9.5.11 prevents query and fragment bearers from entering Admin-visible client telemetry, removes tracked mutable runtime snapshots, fixes shared failure feedback, guards Roulette actions, strengthens reduced-motion behavior, and keeps Teen Patti mobile actions clear of the feedback control. It retains the packaged non-shell production monitor handoff, compatibility-owned predecessor selection, exact v0.9.5.10 application-only rollback target, TiltSeven canonical Casino origin, private-invite security, MySQL schema 2, provider-disablement, and public-exposure gates. Independently versioned modules continue to record compatible source changes. Current module revisions and requirement status are recorded in the canonical manifests and generated requirements document.

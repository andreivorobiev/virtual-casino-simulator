...
function stylesHtml() {
  ...
  return '<style>.pgp-shell{display:grid;gap:16px;min-width:0}.pgp-header{display:flex;align-items:end;justify-content:space-between;gap:16px}.pgp-header h1{margin:0}.pgp-eyebrow{margin:0 0 4px;color:var(--muted,#b8c8c1)}.pgp-phase{padding:7px 12px;border:1px solid rgba(255,215,128,.45);border-radius:999px;color:var(--gold,#f6d47a)}.pgp-layout{display:grid;grid-template-columns:minmax(220px,.72fr) minmax(560px,2.5fr) minmax(240px,.82fr);gap:16px;align-items:start}.pgp-panel,.pgp-stage{border:1px solid rgba(255,215,128,.24);border-radius:16px;background:rgba(3,29,20,.86);padding:16px}.pgp-controls,.pgp-data{display:grid;align-content:start;gap:13px}.pgp-controls h2,.pgp-data h2{margin:0}.pgp-controls fieldset{margin:0;padding:0;border:0;display:grid;gap:10px}.pgp-controls legend{margin-bottom:8px}.pgp-controls input,.pgp-controls button{min-height:44px}.pgp-primary{background:var(--red,#a51f2d);color:#fff}.pgp-set{background:var(--gold,#c99a3a);color:#1a1205}.pgp-help,.pgp-retry,.pgp-empty{color:var(--muted,#b8c8c1)}.pgp-error{min-height:1.4em;margin:0;color:#ffd1d1}.pgp-stage{display:grid;align-content:center;gap:18px;min-width:0;min-height:500px;background:radial-gradient(circle at 50% 44%,rgba(35,130,82,.45),rgba(3,24,17,.98) 70%)}.pgp-table-felt{display:grid;gap:16px}.pgp-card-row{display:grid;justify-items:center;gap:10px}.pgp-card-row h3{margin:0}.pgp-cards,.pgp-tiles{display:flex;flex-wrap:wrap;justify-content:center;gap:10px;min-height:96px}.pgp-tile{padding:4px;border:2px solid transparent;border-radius:12px;background:transparent;cursor:pointer;line-height:0}.pgp-tile-selected{border-color:#ffd780;transform:translateY(-8px)}.pgp-cards .playing-card,.pgp-tiles .playing-card{flex:none;width:clamp(4.2rem,7vw,6.6rem);font-size:clamp(1rem,2vw,1.55rem)}.pgp-result{min-height:2.4em;margin:0;text-align:center}.pgp-summary{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:9px}.pgp-summary span{display:grid;gap:5px;padding:10px;border-radius:10px;background:rgba(255,255,255,.05)}.pgp-summary strong{overflow-wrap:anywhere}.pgp-data section{display:grid;gap:10px}.pgp-rules{margin:0;padding-left:1.1rem}.pgp-rules li+li{margin-top:7px}.pgp-history-list{display:grid;gap:8px;max-height:285px;margin:0;padding:0;overflow:auto;list-style:none;scrollbar-width:thin}.pgp-history-list li{display:grid;grid-template-columns:1fr auto;gap:8px;padding:9px;border-radius:9px;background:rgba(0,0,0,.2)}.pgp-shell button:focus-visible,.pgp-shell input:focus-visible,.pgp-history-list:focus-visible{outline:3px solid #ffd780;outline-offset:2px}@media(max-width:1120px){.pgp-layout{grid-template-columns:1fr}.pgp-controls{order:1}.pgp-stage{order:2;min-height:420px}.pgp-data{order:3}}@media(max-width:560px){.pgp-header{align-items:start;flex-direction:column}.pgp-panel,.pgp-stage{padding:12px}.pgp-stage{min-height:380px}.pgp-cards,.pgp-tiles{gap:7px;min-height:82px}.pgp-cards .playing-card,.pgp-tiles .playing-card{width:clamp(3.4rem,18vw,4.9rem)}.pgp-summary{grid-template-columns:1fr 1fr}.pgp-history-list li{grid-template-columns:1fr}}@media(prefers-reduced-motion:reduce){.pgp-shell *{scroll-behavior:auto!important;transition:none!important;animation:none!important}.pgp-tile-selected{transform:none}}</style>';
}

...
function ensureStyles() {
  ...
  style.textContent = '.color-wheel{display:grid;grid-template-columns:minmax(0,1fr) 300px;gap:16px;width:100%;min-width:0;min-height:100%;color:var(--text,#f5ead6);align-items:start;} .cw-stage{display:grid;justify-items:center;gap:14px;padding:12px;min-width:0;} .cw-wheel-wrap{position:relative;width:min(340px,72vw);aspect-ratio:1;} .cw-wheel{width:100%;height:100%;border-radius:50%;border:8px solid #e7bd58;box-shadow:0 12px 40px rgba(0,0,0,.45),inset 0 0 0 3px #4d2707;transition:transform ' + (SPIN_MS/1000) + 's cubic-bezier(.15,.6,.15,1);} .cw-pointer{position:absolute;top:-6px;left:50%;transform:translateX(-50%);width:0;height:0;border-left:12px solid transparent;border-right:12px solid transparent;border-top:22px solid #f1ca62;filter:drop-shadow(0 2px 3px rgba(0,0,0,.5));z-index:2;} .cw-hub{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:54px;height:54px;border-radius:50%;background:radial-gradient(circle at 38% 34%,#fff5bd,#6b350d);border:2px solid #f2d77d;} .cw-panel{display:grid;gap:12px;min-width:0;} .cw-card{padding:14px;border:1px solid rgba(255,217,120,.42);border-radius:16px;background:rgba(0,0,0,.22);} .cw-card h3{margin:0 0 10px;color:#e7bc52;text-transform:uppercase;font-size:12px;letter-spacing:.08em;} .cw-bets{display:grid;grid-template-columns:1fr 1fr;gap:8px;} .cw-bet{display:grid;gap:2px;padding:10px;border:2px solid transparent;border-radius:12px;color:#fff;font-weight:900;cursor:pointer;text-align:left;} .cw-bet small{font-weight:700;opacity:.85;font-size:11px;} .cw-bet.red{background:linear-gradient(180deg,#d6323d,#8e1822);} .cw-bet.black{background:linear-gradient(180deg,#2a2a2a,#0e0e0e);} .cw-bet.green{background:linear-gradient(180deg,#0f9c4c,#0a5f2e);} .cw-bet.gold{background:linear-gradient(180deg,#f0c45d,#a9791f);color:#241006;} .cw-bet[aria-pressed="true"]{border-color:#fff2c2;box-shadow:0 0 0 2px rgba(255,242,194,.5);} .cw-chips{display:flex;flex-wrap:wrap;gap:8px;} .cw-chip{min-width:44px;min-height:40px;padding:0 10px;border:1px solid var(--border-soft,rgba(255,255,255,.18));border-radius:10px;background:rgba(255,255,255,.05);color:#f5ead6;font-weight:900;cursor:pointer;} .cw-chip[aria-pressed="true"]{border-color:#e7bd58;background:rgba(231,189,88,.16);color:#fff2c2;} .cw-spin{width:100%;min-height:48px;border:none;border-radius:14px;background:linear-gradient(180deg,#d6323d,#8e1822);color:#fff;font-weight:900;font-size:16px;cursor:pointer;} .cw-spin:disabled{opacity:.55;cursor:not-allowed;} .cw-repeat{width:100%;min-height:46px;border:1px solid rgba(255,217,120,.55);border-radius:14px;background:transparent;color:#ffd780;font-weight:900;font-size:15px;cursor:pointer;} .cw-repeat:disabled{opacity:.5;cursor:not-allowed;} .cw-result{min-height:66px;font-size:15px;color:#fff2c2;} .cw-result .net{font-weight:900;} @media (max-width:900px){.color-wheel{grid-template-columns:1fr;}} @media (max-width:640px){.cw-panel{padding-right:160px;}body:has(.color-wheel) .report-problem-fab{width:144px;max-width:144px;white-space:normal;line-height:1.1;}}';

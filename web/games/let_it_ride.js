// Provide the isolated Let It Ride browser module for GitHub issue #134.
// Requirements: CARD-002, CORE-008, I18N-001, I18N-002, UX-001, UX-002, UX-003, UX-006, and LIR-PROPOSED-004.
...
function styleHtml() {
  ...
  const mobile = '@media (max-width:520px){.lir-header{align-items:start;flex-direction:column}.lir-panel{padding:13px}.lir-action-grid,.lir-summary,.lir-units{grid-template-columns:1fr}.lir-stage{grid-template-rows:auto minmax(230px,1fr) auto}.lir-card-slot h3{font-size:.78rem}}';

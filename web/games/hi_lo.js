...
function repeatSafeStylesHtml() {
  ...
  const scoped = stylesHtml().replace('</style>.hilo-repeat', '.hilo-repeat');
...
function render() {
  ...
  root.innerHTML = repeatSafeStylesHtml() + '<section class="hilo-shell" data-testid="hi-lo">' + header + layout + '</section>';

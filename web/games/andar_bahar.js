...
function repeatSafeStylesHtml() {
  ...
  const scoped = stylesHtml().replace('</style>.andar-repeat', '.andar-repeat');
...
function render() {
  ...
  root.innerHTML = repeatSafeStylesHtml() + '<section class="andar-shell" data-testid="andar-bahar">' + header + layout + '</section>';

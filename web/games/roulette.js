...
const PREMIUM_STYLE = [
  ...
  '.roulette-premium .game-stage{padding:13px;overflow:hidden;background:radial-gradient(circle at 42% 10%,rgba(20,10,34,.25),transparent 42%),linear-gradient(150deg,rgba(20,10,34,.98),rgba(20,10,34,.98));}', // Keep the complete illuminated game stage static instead of introducing another primary scroll surface.
  ...
  '@media (prefers-reduced-motion: reduce){.roulette-premium .wheel-ring.spinning,.roulette-premium .ball-dot.spinning{animation:none;}.roulette-wheel .ball-dot.settled{animation:none;}.roulette-spin-orbit::after{animation:none;}.roulette-wheel .wheel-orient,.roulette-wheel .ball-orbit,.roulette-wheel .ball-radial{transition:none!important;animation:none!important;}.roulette-wheel .ball-trail{opacity:0!important;}.roulette-premium .fixed-result.win .roulette-result-pocket,.roulette-premium .table-cell.result-cell,.roulette-premium .outside-cell.result-cell,.roulette-history-pills span.result-cell{animation:none;}}', // Present the authoritative pocket without rotation when the player asks for reduced motion.
  ...
  '.roulette-premium .bet-chip{border:3px dashed #fff6da;background:radial-gradient(circle,#fffdf4 0 24%,var(--gold) 25% 54%,#8a5c07 55% 72%,#5d3c03 73%);box-shadow:0 5px 12px rgba(0,0,0,.55),inset 0 0 0 2px rgba(90,50,0,.55),inset 0 2px 3px rgba(255,255,255,.6);}', // Layer the wager chip like a real edge-striped casino check without moving its center.
  ...
  '@media (max-width:1650px){.roulette-premium .game-layout{grid-template-columns:220px minmax(0,1fr) 235px;gap:12px;}.roulette-premium .roulette-stage{grid-template-columns:220px minmax(0,1fr);min-height:440px;}.roulette-premium .wheel-card{grid-template-columns:1fr;grid-template-rows:minmax(0,1fr) 104px;min-height:440px;}.roulette-premium .roulette-wheel{max-width:214px;}.roulette-table-shell{height:440px;}.roulette-premium .roulette-table-board{transform:scale(.74);transform-origin:top center;}.roulette-premium .control-rail,.roulette-premium .details-drawer{padding:10px;}.roulette-premium .game-title,.roulette-drawer-title h3{font-size:20px;}.roulette-control-section{margin-top:7px;}.roulette-advanced{margin-top:6px;}.roulette-advanced summary{padding:7px 8px;}.roulette-premium .stable-list{min-height:70px;}}', // Keep the stage, wheel, table, and Spin above the compact desktop fold while rails remain secondary.

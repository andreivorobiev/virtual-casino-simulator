...
function stylesHtml() {
  ...
  const desktop = '.thpt-shell{display:grid;gap:16px;min-width:0}.thpt-header{display:flex;align-items:end;justify-content:space-between;gap:16px}.thpt-header h1{margin:0}.thpt-phase{min-width:150px;padding:7px 12px;border:1px solid rgba(255,215,128,.45);border-radius:999px;text-align:center;color:var(--gold,#f6d47a)}.thpt-layout{display:grid;grid-template-columns:minmax(205px,.6fr) minmax(570px,2.4fr) minmax(220px,.65fr);gap:15px;align-items:start;min-width:0}.thpt-panel,.thpt-stage{border:1px solid rgba(255,215,128,.24);border-radius:16px;background:rgba(4,30,21,.9);padding:15px;min-width:0}.thpt-controls{display:grid;align-content:start;gap:12px}.thpt-controls input,.thpt-controls button{min-height:44px}.thpt-primary{background:var(--red,#a92a38);color:#fff}.thpt-repeat{background:transparent;color:#ffd780;border:1px solid rgba(255,215,128,.55)}.thpt-repeat:disabled{opacity:.5}.thpt-decision{display:grid;grid-template-columns:1fr 1fr;gap:9px}.thpt-reserve,.thpt-controls p,.thpt-muted{color:var(--muted,#b8c7c0)}.thpt-stage{display:grid;gap:14px;background:radial-gradient(circle at 50% 45%,rgba(33,126,81,.42),rgba(3,25,17,.96) 72%)}.thpt-opponents{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px}.thpt-seat{display:grid;gap:8px;padding:10px;border:1px solid rgba(255,255,255,.13);border-radius:12px;background:rgba(0,0,0,.16)}.thpt-seat.is-acting{outline:2px solid #ffd780;outline-offset:2px}.thpt-seat.is-folded{opacity:.58}.thpt-seat.is-winner{box-shadow:0 0 0 3px rgba(255,215,128,.42)}.thpt-seat header{display:flex;justify-content:space-between;gap:7px;align-items:center}.thpt-seat h3{margin:0;font-size:.95rem}.thpt-seat header span{font-size:.72rem;color:var(--muted,#b8c7c0)}.thpt-card-row{display:flex;flex-wrap:nowrap;justify-content:center;gap:7px;min-width:0}.thpt-seat .playing-card,.thpt-card-slot{flex:0 1 clamp(2.65rem,5vw,4.6rem);min-width:2.65rem}.thpt-card-slot{display:inline-flex;aspect-ratio:5/7;border:2px dashed rgba(255,255,255,.24);border-radius:.65rem;background:rgba(0,0,0,.12)}.thpt-seat dl{display:grid;grid-template-columns:1fr 1fr;gap:6px;margin:0}.thpt-seat dl div{min-width:0}.thpt-seat dt{color:var(--muted,#b8c7c0);font-size:.68rem}.thpt-seat dd{margin:2px 0 0;font-size:.78rem;overflow-wrap:anywhere}.thpt-table-center{display:grid;place-items:center;gap:13px;min-height:220px;padding:14px;border-radius:48%;background:rgba(6,67,43,.58);border:2px solid rgba(255,215,128,.25)}.thpt-pot{display:grid;justify-items:center}.thpt-pot strong{font-size:clamp(1.1rem,2vw,1.55rem)}.thpt-community{display:grid;justify-items:center;gap:8px;width:100%}.thpt-community h3{margin:0}.thpt-community .playing-card,.thpt-community .thpt-card-slot{flex-basis:clamp(3rem,7vw,5.2rem)}.thpt-human{display:grid;place-items:center}.thpt-human .thpt-seat{width:min(420px,100%)}.thpt-result{display:grid;gap:10px;padding:12px;border-radius:12px;background:rgba(255,215,128,.1);text-align:center}.thpt-result h2,.thpt-result p{margin:0}.thpt-result-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}.thpt-result-grid span{display:grid;gap:3px}.thpt-history,.thpt-rules ul{display:grid;gap:8px;margin:0;padding-left:1.1rem}.thpt-history li{padding-bottom:7px;border-bottom:1px solid rgba(255,255,255,.1)}.thpt-rules{margin-top:18px}.thpt-ready{min-height:520px;place-content:center;text-align:center}.thpt-shell button:focus-visible,.thpt-shell input:focus-visible{outline:3px solid #ffd780;outline-offset:2px}';

...
function ensureStyles() {
  ...
  style.textContent = '.dbvp{display:grid;grid-template-columns:minmax(0,1fr) 300px;gap:16px;width:100%;min-width:0;min-height:100%;color:var(--text,#f5ead6);align-items:start;} .db-header{grid-column:1/-1;display:flex;align-items:end;justify-content:space-between;gap:12px;padding:0 12px;min-width:0;} .db-header h1{margin:0;font-size:clamp(24px,3vw,38px);line-height:1.05;} .db-phase{margin:0;padding:6px 10px;border:1px solid rgba(255,217,120,.42);border-radius:999px;color:#fff2c2;font-size:12px;font-weight:800;} .db-stage{display:grid;gap:16px;padding:12px;min-width:0;justify-items:start;} .db-hand{display:flex;gap:8px;flex-wrap:wrap;min-width:0;} .db-slot{display:grid;justify-items:center;gap:4px;} .db-holdbtn{background:none;border:none;cursor:pointer;padding:0;border-radius:10px;} .db-holdbtn[aria-pressed="true"]{outline:2px solid #f2d77d;outline-offset:3px;} .db-tag{font-size:11px;font-weight:900;color:#f2d77d;text-transform:uppercase;min-height:14px;} .db-actions{display:flex;flex-wrap:wrap;gap:8px;} .db-btn{min-height:44px;padding:0 18px;border:none;border-radius:12px;font-weight:900;font-size:15px;cursor:pointer;} .db-btn.draw{background:linear-gradient(180deg,#0f9c4c,#0a5f2e);color:#fff;} .db-btn.deal{background:linear-gradient(180deg,#d6323d,#8e1822);color:#fff;width:100%;} .db-btn:disabled{opacity:.55;cursor:not-allowed;} .db-repeat{width:100%;margin-top:8px;min-height:44px;padding:0 18px;border:1px solid rgba(255,215,128,.55);border-radius:12px;background:transparent;color:#ffd780;font-weight:900;font-size:15px;cursor:pointer;} .db-repeat:disabled{opacity:.5;cursor:not-allowed;} .db-panel{display:grid;gap:12px;min-width:0;} .db-card{padding:14px;border:1px solid rgba(255,217,120,.42);border-radius:16px;background:rgba(0,0,0,.22);} .db-card h3{margin:0 0 10px;color:#e7bc52;text-transform:uppercase;font-size:12px;letter-spacing:.08em;} .db-field{display:grid;gap:4px;margin-bottom:10px;} .db-field label{font-size:12px;font-weight:700;} .db-field input{width:100%;max-width:100%;min-width:0;min-height:40px;border-radius:10px;border:1px solid rgba(255,255,255,.2);background:rgba(255,255,255,.05);color:#f5ead6;padding:0 10px;font-weight:800;} .db-pays{display:grid;max-width:100%;min-width:0;gap:3px;font-size:12px;font-weight:700;} .db-pays div{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:4px;min-width:0;} .db-pays span{min-width:0;overflow-wrap:anywhere;} .db-pays span:last-child{color:#f2d77d;} .db-result{min-height:24px;font-size:15px;color:#fff2c2;font-weight:800;} .db-result .net{font-weight:900;} @media (max-width:1200px){.db-card>h3,.db-card>.db-field,.db-card>.db-btn,.db-card>.db-pays{width:calc(100% - 160px);max-width:calc(100% - 160px);} body:has(.dbvp) .report-problem-fab{width:144px;max-width:144px;white-space:normal;line-height:1.1;}} @media (max-width:900px){.dbvp{grid-template-columns:1fr;}.db-header{align-items:start;flex-direction:column;}.db-header,.db-stage{padding-inline:0;}}';

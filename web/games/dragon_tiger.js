...
const GAME_CSS = [
  ...
  '.dt-bet,.dt-deal,.dt-repeat{min-height:46px}.dt-bet.is-selected{outline:3px solid #ffd780;outline-offset:2px}.dt-deal{background:#a51f2d;color:#fff}.dt-repeat{background:transparent;color:#ffd780;border:1px solid rgba(255,215,128,.55)}.dt-repeat:disabled{opacity:.5}', // Preserve touch size, non-color selection, and the secondary repeat action.

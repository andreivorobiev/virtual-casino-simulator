...
function ensureStyles() {
  ...
  style.textContent = '.fourcp{display:grid;grid-template-columns:minmax(0,1fr) 300px;gap:16px;width:100%;min-width:0;min-height:100%;color:var(--text,#f5ead6);align-items:start;} .fcp-stage{display:grid;gap:16px;padding:12px;min-width:0;} .fcp-row{display:grid;gap:6px;} .fcp-row h4{margin:0;color:#e7bc52;text-transform:uppercase;font-size:12px;letter-spacing:.08em;} .fcp-cards{display:flex;gap:6px;flex-wrap:wrap;min-width:0;} .fcp-hand{outline:2px solid #f2d77d;outline-offset:3px;border-radius:8px;} .fcp-actions{display:flex;flex-wrap:wrap;gap:8px;} .fcp-btn{min-height:44px;padding:0 16px;border:none;border-radius:12px;font-weight:900;font-size:15px;cursor:pointer;} .fcp-btn.play{background:linear-gradient(180deg,#0f9c4c,#0a5f2e);color:#fff;} .fcp-btn.fold{background:linear-gradient(180deg,#6b6b76,#3a3a42);color:#fff;} .fcp-btn.deal{background:linear-gradient(180deg,#d6323d,#8e1822);color:#fff;width:100%;} .fcp-btn:disabled{opacity:.55;cursor:not-allowed;} .fcp-panel{display:grid;gap:12px;min-width:0;} .fcp-card{padding:14px;border:1px solid rgba(255,217,120,.42);border-radius:16px;background:rgba(0,0,0,.22);} .fcp-card h3{margin:0 0 10px;color:#e7bc52;text-transform:uppercase;font-size:12px;letter-spacing:.08em;} .fcp-field{display:grid;gap:4px;margin-bottom:10px;} .fcp-field label{font-size:12px;font-weight:700;} .fcp-field input{min-height:40px;border-radius:10px;border:1px solid rgba(255,255,255,.2);background:rgba(255,255,255,.05);color:#f5ead6;padding:0 10px;font-weight:800;} .fcp-pays{display:grid;gap:4px;font-size:12px;font-weight:700;} .fcp-pays div{display:flex;justify-content:space-between;} .fcp-pays span:last-child{color:#f2d77d;} .fcp-result{min-height:24px;font-size:15px;color:#fff2c2;font-weight:800;} .fcp-result .net{font-weight:900;} @media (max-width:900px){.fourcp{grid-template-columns:1fr;}}';
...
function render() {
  ...
  root.innerHTML = `<section class="fourcp" data-testid="four-card-poker"><div class="fcp-stage">${stage}</div><div class="fcp-panel">${panel}</div></section>`;

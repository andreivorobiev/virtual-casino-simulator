...
function dataHtml() {
  ...
  return '<aside class="choldem-panel choldem-data" aria-label="' + safe(text('data.title')) + '"><section><h2>' + safe(text('rules.title')) + '</h2><ul class="choldem-rules"><li>' + safe(text('rules.callMultiplier', { multiplier: callMultiplier })) + '</li><li>' + safe(text('rules.dealerQualifies')) + '</li><li>' + safe(text('rules.noValue')) + '</li></ul></section><section><h2>' + safe(text('history.title')) + '</h2>' + historyHtml() + '</section></aside>';
}

...
function styleHtml() {
  ...
  return `<style data-baccarat-style>.bac-shell{display:grid;grid-template-rows:auto minmax(0,1fr);gap:14px;height:100%;min-height:0}.bac-header{display:grid;grid-template-columns:minmax(260px,1fr) minmax(420px,48%);gap:14px;align-items:end;min-height:90px}.bac-kicker{margin:0 0 5px;color:#fff2c2;font-size:13px}.bac-title{margin:0;color:var(--gold);font-family:var(--font-display);font-size:54px;line-height:1}.bac-status-rail{display:grid;grid-template-columns:repeat(4,1fr);overflow:hidden;border:1px solid rgba(255,199,83,.58);border-radius:8px;background:rgba(6,22,16,.86)}.bac-status-rail span{display:grid;place-items:center;min-height:62px;padding:0 10px;border-left:1px solid rgba(255,199,83,.18);color:#fff2c2;font-weight:900;text-align:center}.bac-status-rail span:first-child{border-left:0}.bac-rail-card{margin:8px 0;padding:10px;border:1px solid var(--border-soft);border-radius:8px;background:rgba(255,255,255,.04)}.bac-rail-card label{font-size:12px;font-weight:900;text-transform:uppercase}.bac-rail-card select{min-height:38px}.bac-chip-row{display:flex;gap:9px;flex-wrap:wrap;margin-bottom:10px}.bac-chip-row .chip{width:54px;height:54px}.bac-repeat-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:6px}.bac-repeat-grid button{min-height:38px;padding:0 6px}.bac-deal-button{width:100%;min-height:48px;margin-top:8px}#botPanel.bac-rail-card{max-height:58px;overflow:auto}#auto.bac-rail-card{max-height:132px;overflow:auto}.bac-stage-head{display:flex;gap:12px;align-items:center;justify-content:space-between;margin-bottom:10px}.bac-coup-label{color:#b7cbbc;font-size:12px}.bac-stage-title{margin:2px 0 0;color:#fff2c2;font-family:var(--font-display);font-size:31px}.bac-stage-badge{min-width:120px;padding:12px;border:1px solid var(--border-soft);border-radius:8px;background:rgba(255,255,255,.08);color:#fff2c2;font-weight:900;text-align:center}.bac-board{display:grid;grid-template-rows:minmax(160px,auto) minmax(180px,1fr);gap:14px;min-height:470px;padding:24px 30px;border:2px solid rgba(255,215,128,.42);border-radius:8px;background:radial-gradient(circle at 50% 62%,rgba(20,115,75,.72),rgba(6,59,36,.96) 52%,rgba(3,35,24,.98));box-shadow:inset 0 0 70px rgba(255,217,120,.05)}.bac-hand-grid{display:grid;grid-template-columns:1fr 1fr;gap:24px}.bac-hand-panel{min-height:154px;padding:14px;border:1px solid rgba(255,215,128,.46);border-radius:8px;background:rgba(4,31,23,.48)}.bac-hand-top{display:flex;justify-content:space-between;gap:8px;color:#fff2c2;font-weight:900}.bac-card-row{display:flex;gap:12px;align-items:center;min-height:104px;margin-top:12px}.bac-card{width:72px;height:104px;font-size:30px;line-height:1.15}.bac-card span:last-child{font-size:25px}.bac-card.placeholder{border:1px dashed rgba(255,255,255,.14);background:rgba(255,255,255,.04);box-shadow:none}.bac-card.revealing{animation:bacReveal .62s cubic-bezier(.2,.8,.22,1) both}@keyframes bacReveal{from{opacity:.2;transform:translateY(22px) rotate(-7deg)}to{opacity:1;transform:translateY(0) rotate(0)}}.bac-wager-grid{display:grid;grid-template-columns:1.4fr 1fr 1.4fr;gap:14px;align-items:stretch}.bac-wager-zone{position:relative;display:grid;place-items:center;min-height:180px;border:2px solid rgba(255,255,255,.18);border-radius:8px;color:#fff8df;font-family:var(--font-display);font-size:31px;font-weight:900;text-align:center;box-shadow:inset 0 0 34px rgba(255,255,255,.04)}.bac-wager-zone.player{background:linear-gradient(135deg,rgba(14,92,116,.86),rgba(9,60,77,.88))}.bac-wager-zone.tie{background:linear-gradient(135deg,rgba(48,65,101,.86),rgba(35,44,69,.9))}.bac-wager-zone.banker{background:linear-gradient(135deg,rgba(116,55,45,.88),rgba(77,36,31,.9))}.bac-wager-zone.winner{border-color:var(--gold);box-shadow:0 0 0 1px var(--gold),inset 0 0 44px rgba(255,217,120,.16)}.bac-wager-zone.lost{opacity:.48}.bac-zone-chip{position:absolute;top:-14px;right:-10px;display:grid;place-items:center;width:48px;height:48px;border:5px dashed rgba(255,255,255,.82);border-radius:50%;color:#211600;background:radial-gradient(circle,#fff 0 28%,#e4b12f 29% 56%,#9b6800 57%);font-family:var(--font-body);font-size:12px}.bac-drawer-total{display:grid;grid-template-columns:1fr auto;gap:8px;align-items:center;margin-bottom:8px;padding:11px;border:1px solid rgba(255,215,128,.4);border-radius:8px;background:rgba(255,217,120,.07);color:#fff2c2;font-weight:900}.bac-road-grid{display:grid;grid-template-columns:repeat(6,34px);gap:8px;min-height:118px;padding:11px;border:1px solid var(--border-soft);border-radius:8px;background:rgba(0,0,0,.14)}.bac-road-cell{display:grid;place-items:center;width:34px;height:34px;border:1px dashed rgba(255,255,255,.12);border-radius:50%;color:#fff;font-size:12px;font-weight:1000}.bac-road-cell.player{border:0;background:#1e65b7}.bac-road-cell.banker{border:0;background:#bf2634}.bac-road-cell.tie{border:0;background:#6b3c9c}.bac-road-cell.latest{outline:3px solid var(--gold);outline-offset:2px}.bac-log{display:grid;gap:8px}.bac-log-row{padding:9px 10px;border:1px solid var(--border-soft);border-radius:8px;background:rgba(0,0,0,.14)}.bac-shoe-grid{display:grid;grid-template-columns:1fr 1fr;gap:8px}.bac-shoe-grid .stat{min-height:52px;margin:0;padding:8px;border-radius:8px}.bac-score{max-height:120px;overflow:auto}.bac-disabled-note{opacity:.64}.bac-drawer-section{margin-top:12px}@media(max-width:1200px){.bac-shell{height:auto}.bac-header{grid-template-columns:1fr}.bac-title{font-size:42px}.bac-status-rail{grid-template-columns:repeat(2,1fr)}.bac-board{min-height:auto;padding:18px}.bac-hand-grid,.bac-wager-grid,.bac-shoe-grid{grid-template-columns:1fr}.bac-wager-zone{min-height:150px}.bac-card{width:64px;height:92px;font-size:25px}.bac-road-grid{grid-template-columns:repeat(6,30px)}.bac-road-cell{width:30px;height:30px}}</style>`;
}

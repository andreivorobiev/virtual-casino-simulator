...
async function play() {
  ...
  try {
    // Send a stable action identity and the complete wager map in one request.
    const response = await post('/api/v1/games/fan-tan/rounds', { action_id: createActionId(), wagers });

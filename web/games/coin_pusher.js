...
function ensureStyles() {
  ...
  style.textContent = '.coinp{display:grid;grid-template-columns:minmax(0,1fr) 300px;gap:16px;width:100%;min-width:0;min-height:100%;color:var(--text,#f5ead6);align-items:start;} .cp-stage{display:grid;justify-items:center;gap:14px;padding:12px;min-width:0;} .cp-machine{width:min(340px,80vw);display:grid;gap:10px;} .cp-tray{position:relative;height:120px;border-radius:14px 14px 8px 8px;background:linear-gradient(180deg,#1a2b3a,#0a1520);border:5px solid #e7bd58;overflow:hidden;box-shadow:inset 0 8px 24px rgba(0,0,0,.5);} .cp-fill{position:absolute;left:0;bottom:0;width:100%;background:linear-gradient(180deg,rgba(231,189,88,.35),rgba(231,189,88,.7));transition:height .4s ease;} .cp-coins{position:absolute;bottom:6px;width:100%;display:flex;justify-content:center;gap:4px;flex-wrap:wrap;padding:0 8px;} .cp-coin{width:22px;height:22px;border-radius:50%;background:radial-gradient(circle at 36% 32%,#fff3bd,#a9791f);box-shadow:0 2px 4px rgba(0,0,0,.4);} .cp-coin.drop{animation:cp-fall .5s ease forwards;} @keyframes cp-fall{to{transform:translateY(60px);opacity:0;}} .cp-edge{height:8px;border-radius:0 0 8px 8px;background:linear-gradient(180deg,#e7bd58,#a9791f);} .cp-meter{display:flex;justify-content:space-between;font-size:12px;font-weight:700;color:#e7bc52;text-transform:uppercase;letter-spacing:.06em;} .cp-panel{display:grid;gap:12px;min-width:0;} .cp-card{padding:14px;border:1px solid rgba(255,217,120,.42);border-radius:16px;background:rgba(0,0,0,.22);} .cp-card h3{margin:0 0 10px;color:#e7bc52;text-transform:uppercase;font-size:12px;letter-spacing:.08em;} .cp-pays{display:grid;gap:6px;font-size:13px;font-weight:700;} .cp-pays div{display:flex;justify-content:space-between;} .cp-pays span:last-child{color:#f2d77d;} .cp-chips{display:flex;flex-wrap:wrap;gap:8px;} .cp-chip{min-width:44px;min-height:40px;padding:0 10px;border:1px solid var(--border-soft,rgba(255,255,255,.18));border-radius:10px;background:rgba(255,255,255,.05);color:#f5ead6;font-weight:900;cursor:pointer;} .cp-chip[aria-pressed="true"]{border-color:#e7bd58;background:rgba(231,189,88,.16);color:#fff2c2;} .cp-drop{width:100%;min-height:48px;border:none;border-radius:14px;background:linear-gradient(180deg,#e7bd58,#a9791f);color:#241006;font-weight:900;font-size:16px;cursor:pointer;} .cp-drop:disabled{opacity:.55;cursor:not-allowed;} .cp-repeat{width:100%;min-height:46px;border:1px solid rgba(255,215,120,.55);border-radius:14px;background:transparent;color:#ffd780;font-weight:900;font-size:15px;cursor:pointer;} .cp-repeat:disabled{opacity:.5;cursor:not-allowed;} .cp-result{min-height:24px;font-size:15px;color:#fff2c2;text-align:center;} .cp-result .net{font-weight:900;} @media (prefers-reduced-motion:reduce){.cp-coin.drop{animation:none;opacity:0;}} @media (max-width:900px){.coinp{grid-template-columns:1fr;}}';

...
function stylesHtml() {
  ...
  return `<style>
    ...
    @media(max-height:950px) and (min-width:1101px){#view.game-screen:has(.sb-shell){overflow-y:auto;scrollbar-width:thin;scrollbar-color:#b98a3a rgba(255,255,255,.05)}#view.game-screen:has(.sb-shell) .sb-data{max-height:none;overflow:visible}}

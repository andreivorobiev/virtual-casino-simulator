...
function repeatSafeStylesHtml() {
  ...
  const scoped = stylesHtml().replace('</style>.jp-repeat', '.jp-repeat');
...
function render() {
  ...
  root.innerHTML = repeatSafeStylesHtml() + '<section class="jp-shell" data-testid="joker-poker">' + header + layout + '</section>';

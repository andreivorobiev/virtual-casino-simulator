...
function ensureStyles() {
  ...
  style.textContent = '.lucky{display:grid;grid-template-columns:minmax(0,1fr) 300px;gap:16px;width:100%;min-width:0;min-height:100%;color:var(--text,#f5ead6);align-items:start;} .lg-stage{display:grid;justify-items:center;gap:14px;padding:12px;min-width:0;} .lg-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;width:min(300px,74vw);} .lg-cell{aspect-ratio:1;border-radius:12px;background:rgba(255,255,255,.06);border:2px solid rgba(255,255,255,.12);display:grid;place-items:center;font-size:26px;font-weight:900;color:var(--text);cursor:pointer;} .lg-cell[aria-pressed="true"]{border-color:var(--brand);box-shadow:0 0 0 2px rgba(255,59,107,.5);background:rgba(231,189,88,.14);} .lg-cell.prize{background:radial-gradient(circle at 40% 34%,#fff3bd,#e7bd58);color:#241006;} .lg-cell.matched{background:radial-gradient(circle at 40% 34%,#bff0cf,#0f9c4c);color:#052312;box-shadow:0 0 0 2px var(--brand);} .lg-panel{display:grid;gap:12px;min-width:0;} .lg-card{padding:14px;border:1px solid var(--gold);border-radius:16px;background:rgba(0,0,0,.22);} .lg-card h3{margin:0 0 10px;color:var(--gold);text-transform:uppercase;font-size:12px;letter-spacing:.08em;} .lg-pays{display:grid;gap:6px;font-size:13px;font-weight:700;} .lg-pays div{display:flex;justify-content:space-between;} .lg-pays span:last-child{color:var(--gold);} .lg-chips{display:flex;flex-wrap:wrap;gap:8px;} .lg-chip{min-width:44px;min-height:40px;padding:0 10px;border:1px solid var(--border-soft,rgba(255,255,255,.18));border-radius:10px;background:rgba(255,255,255,.05);color:var(--text);font-weight:900;cursor:pointer;} .lg-chip[aria-pressed="true"]{border-color:#e7bd58;background:rgba(231,189,88,.16);color:var(--text);} .lg-go{width:100%;min-height:48px;border:none;border-radius:14px;background:linear-gradient(180deg,var(--brand),var(--brand-strong));color:#fff;font-weight:900;font-size:16px;cursor:pointer;} .lg-go:disabled{opacity:.55;cursor:not-allowed;} .lg-result{min-height:24px;font-size:15px;color:var(--text);text-align:center;} .lg-result .net{font-weight:900;} @media (max-width:900px){.lucky{grid-template-columns:1fr;}}.lg-repeat{width:100%;min-height:46px;border:1px solid var(--gold);border-radius:14px;background:transparent;color:var(--gold);font-weight:900;cursor:pointer;}.lg-repeat:disabled{opacity:.5;cursor:not-allowed;}';

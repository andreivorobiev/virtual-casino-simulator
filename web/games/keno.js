...
function ensureStyles() {
  ...
  style.textContent += '/* Compact desktop containment: preserve one outer vertical scroller while the board retains horizontal ownership. */ @media (min-width:1201px) and (max-height:950px){.keno-premium,.keno-layout{height:auto;overflow:visible;}.keno-control-panel,.keno-stage-panel,.keno-detail-panel{height:auto;overflow:visible;}}';

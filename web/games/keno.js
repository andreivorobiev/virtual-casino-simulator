...
function boardHtml() {
  ...
  return `<div class="keno-board-shell"><div class="keno-board-scroll"><div class="keno-grid keno-premium-board" data-testid="keno-grid">${Array.from({ length: 80 }, (_, index) => boardCellHtml(index + 1, drawnSet, catchSet, latest)).join('')}</div></div></div>`;
}

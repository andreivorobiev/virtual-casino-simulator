# AGENTS.md - admin module

Scope this Codex conversation to the `admin` module unless the task explicitly lists impacted components.
...
- Read `modules/admin.json` before editing.

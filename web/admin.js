...
function injectResponsiveAdminStyles() {
  ...
  style.textContent = '@media (max-width:900px){' +
    ...
    // Turn the vertical sidebar into a horizontal, scrollable tab rail at the top of the page.
    '.admin-sidebar{flex-direction:row;flex-wrap:nowrap;gap:6px;overflow-x:auto;overflow-y:hidden;border-right:0;border-bottom:1px solid rgba(255,255,255,.12);}' +
